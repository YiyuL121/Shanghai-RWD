...
```
```{r}
Full_treated <- ind_fit_plt2(full_ind_t[,c(16:22,38,36)]) #This refers to the mode parameters + t_treat + antiviral
Not_Full_treated <- ind_fit_plt2(Not_Full_ind_t[,c(16:22,38,36)]) #This refers to the mode parameters + t_treat + antiviral
Booster_treated <- ind_fit_plt2(Booster_ind_t[,c(16:22,38,36)]) #This refers to the mode parameters + t_treat + antiviral
Full_Booster_treated <- ind_fit_plt2(Full_Booster_ind_t[,c(16:22,38,36)]) #This refers to the mode parameters + t_treat + antiviral
```
```{r}
...
```
```{r}
old_treated <- ind_fit_plt2(old_ind_t[,c(16:22,38,36)]) #This refers to the mode parameters + t_treat + antiviral
young_treated <- ind_fit_plt2(young_ind_t[,c(16:22,38,36)])  #This refers to the mode parameters + t_treat + antiviral
```
```{r}
old_treated$age <- ">=65"
